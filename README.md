...
> response — on **every input and output**. Runs in-process (SDK) or as a
> shared HTTP gateway.
...
|---|-------|-----------|---------|---------|
| 1 | Shell | [zap](https://github.com/rtk-ai/rtk)/RTK binary filters tool output; built-in heuristic fallback | on | 60–90% on command output |
